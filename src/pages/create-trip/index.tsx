...
export function CreateTripPage() {
    ...
    const [emailsToInvite, setemailsToInvite] = useState(['milleny@gmail.com', 'vinicio@gmail.com'])
            ...
            <div className="max-w-3xl w-full px-6 text-center space-y-10">
                ...
                <p className="text-sm text-zinc-500">Ao planejar sua viagem pela plann.er você automaticamente concorda <br />
                    com nossos <a className="text-zinc-300 underline"
                        href="">termos de uso</a> e <a className="text-zinc-300 underline" href="">políticas de privacidade</a>.</p>
            </div>
